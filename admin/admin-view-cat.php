...
<body id="page-top">
 ...
 <?php include("vendor/inc/a-nav.php");?>
  ...
  <div class="card-header">
    ...
    Registered Customer Cat
    <a href="admin-manage-cat.php" class="btn btn-outline-primary btn-sm" style="background-color: #4e3b31; border: 2px solid black; color: white;">Add Cat Detail</a>
  </div>
  <div class="card-body">
