            ...
            <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="admin-approve-feedback.php?f_id=<?php echo $row->f_id; ?>" class="badge badge-success" style="background-color: #4B3D3D; color: white; border-radius: 5px; text-decoration: none;">
                                <i class="fa fa-check"></i> Publish
                            </a>
                            <a href="admin-delete-feedback.php?f_id=<?php echo $row->f_id; ?>" 
