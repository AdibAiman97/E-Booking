        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Booking Room</li>
                </ol>

                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-cat"></i> Booking Room
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="user-confirm-booking.php?v_id=<?php echo $row->v_id; ?>" class="btn btn-outline-success">
                                                    <i class="fa fa-clipboard"></i> Book Room
                                                </a>
                                            </td>
                                        </tr>
                                    <?php $cnt++;
                    ...
                    <div class="card-footer small text-muted" style="color: white;">
                        <?php
