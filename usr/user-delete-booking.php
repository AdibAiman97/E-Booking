  ...
  if(isset($_POST['delete_booking']))
    {
            ...
            $query="update tms_user set u_package=?, u_car_type=?, u_car_regno=?, u_car_bookdate=?,  u_car_book_status=?, u_enddate=?, u_car_booktime=?, u_car_returntime=? where u_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssssi', $u_package, $u_car_type, $u_car_regno, $u_car_bookdate, $u_car_book_status, $u_enddate, $u_car_booktime, $u_car_returntime, $u_id);
            $stmt->execute();
                if($stmt)
                {
        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
                ...
                <input type="email" readonly placeholder="<?php echo $row->u_package;?>" class="form-control" name="u_package">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Category Room</label>
                <input type="email" readonly placeholder="<?php echo $row->u_car_type;?>" class="form-control" name="u_car_type">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Price Room</label>
            ...
            <div class="form-group">
                ...
                <input type="text" readonly placeholder="<?php echo $row->u_enddate;?>" class="form-control"   name="u_enddate">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Check In Time</label>
                <input type="text" readonly placeholder="<?php echo $row->u_car_booktime;?>" class="form-control"   name="u_car_booktime">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Check Out Time</label>
                <input type="text" readonly placeholder="<?php echo $row->u_car_returntime;?>" class="form-control"   name="u_car_returntime">
            </div>
